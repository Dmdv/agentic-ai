...
""")
    ...
    async def setup_mcp_servers(self):
        ...
        # 9. Free Web Search Server (Python) - Replaces paid Brave API
        ddg_search_params = StdioServerParameters(
            command=venv_python,
            args=["mcp_server_ddg.py"],
        )
