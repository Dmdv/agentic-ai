...
tools:
  allowed:
    - run_bash_command  # For gh CLI commands
    - mcp__claude-flow__swarm_init
    - mcp__claude-flow__agent_spawn
    - mcp__claude-flow__task_orchestrate
    - mcp__claude-flow__memory_usage
...
tools:
  allowed:
    ...
    - run_bash_command  # For system commands
  restricted:
...
- write_file orchestrator coordinates multi-agent workflows
