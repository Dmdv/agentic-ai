...
if __name__ == "__main__":
    ...
    parser.add_argument("--architect", type=str, default="mlx-community/Qwen3-Coder-Next-80B-4bit", help="The planning model.")
    parser.add_argument("--engineer", type=str, default="mlx-community/Qwen3-Coder-Next-80B-4bit", help="The executing model.")
